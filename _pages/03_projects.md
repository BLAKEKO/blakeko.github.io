            ...
            <ul class="timeline">
                <li class="timeline-item">
                    ...
                    <div class="timeline-content">
                        ...
                        <p>Developing a smart speaker service that curates classical music, named Classic Mate(CM). Each day one pair of classical musics are provided with simple explanations based on user's response. </p>
                    </div>
                </li>
                <li class="timeline-item">
                    <div class="timeline-info">
                ...
                <li class="timeline-item">
                    ...
                    <div class="timeline-content">
                        ...
                        <p><b>Project with Korea Creative Content Agency, KOCCA</b></p>
                        <p> Developing a smart speaker service that curates events in various domains such as, but not limited to, classical music, musicals, plays, and concerts. Investigating the potential use of user preference data on various everyday objects to supplement the recommendation of cultural events. <br>
