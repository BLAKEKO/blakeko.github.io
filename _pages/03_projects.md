            ...
            <ul class="timeline">
                <li class="timeline-item">
                    ...
                    <div class="timeline-content">
                        ...
                        <p>Developing a smart speaker service that curates classical music, named Classic Mate(CM).Each day one pair of classical musics are provided with simple explanations. </p>
                    </div>
                </li>
                <li class="timeline-item">
                    <div class="timeline-info">
